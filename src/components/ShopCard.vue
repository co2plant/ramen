<template>
  <div class="bg-gray-800/60 border border-gray-700 rounded-2xl shadow-lg overflow-hidden transform hover:-translate-y-2 transition-transform duration-300 cursor-pointer group" @click="$emit('click')">
